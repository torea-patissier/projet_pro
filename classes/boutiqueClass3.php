...
class boutique extends bdd
{
    ...
    public function showArticles()
    {
        ...
        if (isset($_GET['show'])) {
            ...
            $idProduit = $_GET['show'];             // GET stocké dans une variable
            $request = $con->prepare("SELECT * FROM produits WHERE id = '" . $idProduit . "' "); // Requête SQL
            ...
            <div class="row ">
                <div class="col s12 center-align ">
                    ...
                    ?>
                        ...
                        <a class="btn black" href="panier.php?action=ajout&amp;l=<?php echo $s->nom; ?>&amp;q=1&amp;p=<?php echo $s->prix; ?>&amp;i=<?php echo $s->id ?>">Acheter</a>
            ...
            ?>
                <div class="row">
                    ...
                    <div class="coco col s6 m3 l12">
                        ...
                        <a href="?show=<?php echo $r->id; ?>"><img class="bordureProduit" src="../Images/<?php echo $r->image_nom; ?>.jpg" width="150px" height="150px" /></a>
